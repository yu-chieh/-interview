...
這是一個FOR 面試用專案，基於 Spring Boot 的 RESTful API 專案，主要功能是提供貨幣的匯率資訊。專案會從 CoinDesk API 取得最新匯率，並將其儲存在資料庫中。同時，它也提供了標準的 CRUD (Create, Read, Update, Delete) 功能，讓使用者可以手動管理匯率資料。
